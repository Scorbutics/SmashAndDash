...
class DialogMenu : public IDialogMenu, public ska::Widget
{
public:
	...
	void setButtonClose(std::unique_ptr<ska::ButtonQuit>& button);
...
protected:
	...
	std::unique_ptr<ska::ButtonQuit> m_closeButton;
    ...
    std::vector<std::unique_ptr<ska::Widget>> m_widgets;
