...
CommandStop::CommandStop(ska::EntityManager& entityManager) : 
...
std::string CommandStop::execute(ska::ScriptComponent&, ska::MemoryScript&, const std::vector<std::string>&) {
