...
/* TODO : faire une scène (héritant de la classe State) cinématique */
std::string CommandCinematic::execute(ska::ScriptComponent&, ska::MemoryScript& memory, const std::vector<std::string>& ) {
