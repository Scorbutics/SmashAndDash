========================================================================
    BIBLIOTHÈQUE STATIQUE : Vue d'ensemble du projet ska_gui_test
========================================================================

AppWizard a créé ce projet de bibliothèque ska_gui_test à votre intention.

Aucun fichier source n'a été créé dans le cadre de votre projet.


ska_gui_test.vcxproj
