...
namespace ska {
	...
	public:
		ScriptUtils();
		static std::string getValueFromVarOrSwitchNumber(const ska::Savegame& saveGame, const ScriptComponent& script, std::string varNumber);
		static std::string replaceVariablesByNumerics(const ska::Savegame& saveGame, const ScriptComponent& script, const std::string& line);
		static std::string replaceVariablesByNumerics(const ska::Savegame& saveGame, const ScriptComponent& script, const std::string& line, char varStartSymbol, char varEndSymbol);
