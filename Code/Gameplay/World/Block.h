...
{
	public:
		Block(ska::Rectangle corr, unsigned int idSprite, unsigned int properties, bool auto_animation, int col);
	Block(ska::Rectangle corr, ska::Rectangle posChipset, unsigned int properties, bool auto_animation, int col);
