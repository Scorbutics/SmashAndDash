...
void Pokeball::launch(Character* hero, SDL_Rect destPos)
{
    ...
    //experimental (trouvé à l'aide de l'étude théorique mais "arrangé" [théorème de l'arrangement]) :
...
void Pokeball::setCapture(bool b)
{
    m_capture = b;
}
