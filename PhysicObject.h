...
class PhysicObject
{
	...
	protected :															//tout ce qui doit être accessible dans les classes filles, sans se soucier de l'accélération ou des forces
        ...
        bool m_ghost, m_movementsEnabled, m_canFly;                  //m_ghost : mouvements sans condition de collision
        SDL_Rect m_rect;
		int m_id, m_offset[4], m_jumpHeight;
		unsigned int m_direction, m_entityNumber, m_speedLimit;
